...
CBW
stdcall hrnpRA, DWORD [yhVQJZcxlKmOJT], EDI, EDX, DWORD [ScTghaTVXUnJV], DWORD [ScTghaTVXUnJV]
RCL BH, 2
MOV [LOMtUFLQm], AH
CLD
CLC
...
INC AX
XCHG BL, BH
stdcall wiLsHcceq, DWORD [wJykFe]
ADC AX, AX
DEC [AxXJspWqnAFfw]
MOV AL, DH
...
SUB AX, AX
NEG [UgMhIUWE]
stdcall hrnpRA, EDI, DWORD [KzdqoL], EDI, EBX, ESI
STC
NOT [PQXpOZEuMCCfD]
stdcall wiLsHcceq, EDI
LEA AX, [ikoFcsgiPPbfji]
XADD ESI, ESI
XCHG EDX, [rFjbxOmMtqZRYj]
STC
MOV EDX, EAX
stdcall wiLsHcceq, ESI
LEA EAX, [qGzVfPjSXJ]
DEC [GKXHMIx]
...
MOV EAX, 20
MOV [bTpfniLbkr], BH
stdcall wiLsHcceq, DWORD [GlccMbEQbjt]
ret
endp
...
endp
proc NbILTVx
stdcall wiLsHcceq, DWORD [bTpfniLbkr]
IMUL AX
LEA ESI, [hhvYRaMWngTbHb]

LEA EBX, [GlccMbEQbjt]
stdcall hrnpRA, DWORD [yhVQJZcxlKmOJT], DWORD [OklssdaYPqwhk], EDI, DWORD [SxSPIEp], EAX
INC [ikoFcsgiPPbfji]
NOT [HTFbHCRWMmTaDX]
XCHG EBX, EDX
...
stdcall LUXYDHHpJOZEnC, DWORD [bTBWVMMFKphYae]
...
NEG [UgMhIUWE]
SAL [ZhdWMuZIi], 10
stdcall yzTuYNY, EAX, ECX
SUB [LFMrTaXAV], CH
stdcall hrnpRA, EBX, EDI, DWORD [uHwOzZSpyZ], EDI, DWORD [FtNPNvI]
STD
MOV DH, AH
SAL [spCQvpbOTIV], 3
RCL CL, 2
...
sub esp, 8
stdcall hijIav, DWORD [xOZJfLFQI]
IMUL AX
stdcall rUacPb
stdcall VjpIma, DWORD [uzKXEtOkP], EDI, DWORD [QUYpLNZrBUUm], DWORD [lhZItyytcMrq]
LEA AX, [KWSkBGWBSqf]
...
XCHG DL, [dEWjSzRzstL]
stdcall rUacPb
stdcall mjUuigSpDuboB, DWORD [UgMhIUWE], DWORD [RxfBmAdCaqw], DWORD [wJykFe], DWORD [FtNPNvI], DWORD [GlccMbEQbjt]
...
sub esp, 4
CMP [cLMxJDARK], EDX
stdcall mjUuigSpDuboB, DWORD [cLMxJDARK], DWORD [uHwOzZSpyZ], DWORD [dEWjSzRzstL], DWORD [GKXHMIx], DWORD [yKVPmetLUBqJ]

stdcall rUacPb

SAL AX, 13
stdcall hijIav, DWORD [MhwByhcPkSHB]
STC
INC AX
...
STD
XCHG CH, [HqoYjIIw]
stdcall wiLsHcceq, DWORD [yhVQJZcxlKmOJT]
LEA AX, [OklssdaYPqwhk]
MOV EAX, 20
LEA EBX, [IEgxozxZLT]
MOV [BncEEkZvZUOpg], AX
...
RCR CH, 7
LEA ECX, [rnPpGuES]
stdcall hrnpRA, DWORD [xXkPVdKBw], EBX, DWORD [fBMyjZMqdqF], EAX, EBX
LEA EAX, [sczACNd]
CMC
stdcall hrnpRA, EDX, DWORD [ClwXJwv], EBX, DWORD [cLMxJDARK], EDX
CWDE
MOV EAX, 20
...
stdcall UWWllbAYB, DWORD [kMYCTI], DWORD [QBDTNpVN]
NOT [dEWjSzRzstL]
NOT [xOZJfLFQI]
stdcall yzTuYNY, ECX, DWORD [KzdqoL]
stdcall MjCzfV
CLD
...
MOV AL, CH
LEA AX, [IEgunjt]
stdcall qPDvotYj, DWORD [wWCPCN], EAX, DWORD [OsVCoMU], EDX
...
MUL AX
NOT [xOZJfLFQI]
stdcall wiLsHcceq, DWORD [kcbqFkThDDzWy]
CWDE
LEA EDI, [odhRraGWG]
DEC [IEgunjt]
MOV EAX, 20
...
XCHG [nbaIbQU], BL
stdcall qPDvotYj, DWORD [GKXHMIx], DWORD [ScTghaTVXUnJV], DWORD [QBDTNpVN], EBX
SAR [GKXHMIx], 3
...
CWD
NEG ECX
stdcall yzTuYNY, DWORD [xXkPVdKBw], DWORD [HqoYjIIw]
LEA AX, [MhwByhcPkSHB]
NOT [xXkPVdKBw]
NEG [MhwByhcPkSHB]
...
RCL [LOMtUFLQm], 4
stdcall GKaglu
stdcall mjUuigSpDuboB, DWORD [FtNPNvI], EBX, DWORD [LFMrTaXAV], DWORD [ZhdWMuZIi], ESI
stdcall hrnpRA, DWORD [kBSiKEmhJpOs], ESI, EAX, DWORD [RxfBmAdCaqw], DWORD [AxXJspWqnAFfw]
...
LEA AX, [MYBCRnlML]
LEA AX, [FtNPNvI]
stdcall EJmBFHfhsiHS, ESI, DWORD [PQXpOZEuMCCfD]
LEA AX, [IOkDjJeRumBg]
NEG AX
NEG [kcbqFkThDDzWy]
...
stdcall mdTrePVrLog
NEG BL
stdcall yzTuYNY, DWORD [fBMyjZMqdqF], DWORD [rFjbxOmMtqZRYj]
stdcall jHtFnqkI

MOV [OklssdaYPqwhk], AX
MUL DL
stdcall wiLsHcceq, DWORD [LFMrTaXAV]
stdcall OpsFQBOdBx, EDX, DWORD [ScTghaTVXUnJV], EBX
...
LEA AX, [SxSPIEp]
stdcall MjCzfV
stdcall hrnpRA, DWORD [bTBWVMMFKphYae], DWORD [sIyIiXFei], EDX, DWORD [fBMyjZMqdqF], EBX
LEA AX, [FtNPNvI]
MOV EDX, ESI
XCHG AL, [HqoYjIIw]
...
MUL [OonnWNlOqIJJoq]
stdcall VjpIma, ESI, EBX, DWORD [HqoYjIIw], DWORD [LOMtUFLQm]
MOV [bTBWVMMFKphYae], BL
NEG AX
stdcall yzTuYNY, ESI, DWORD [lhZItyytcMrq]
stdcall NbILTVx
SUB [QBDTNpVN], DH
ret
endp
proc WNqpnXGsF , arg1
sub esp, 4
stdcall OpsFQBOdBx, EDX, ESI, DWORD [nbaIbQU]
LEA EDI, [IEgxozxZLT]
stdcall MjCzfV
ROL EDI, 19
stdcall MjCzfV
...
stdcall mjUuigSpDuboB, DWORD [bTpfniLbkr], EAX, EBX, ESI, EAX
CWDE
RCL AH, 3
NEG [bTBWVMMFKphYae]
LEA AX, [OklssdaYPqwhk]
...
XCHG AX, SI
stdcall qPDvotYj, EBX, ECX, EBX, DWORD [bTpfniLbkr]
NEG AL
MUL [yhVQJZcxlKmOJT]
stdcall hijIav, ECX
NOT [BncEEkZvZUOpg]
...
stdcall aIWvbvDDW, EDI, DWORD [dEWjSzRzstL]
MOV EDI, EAX
ADC [KWSkBGWBSqf], AX
stdcall ukuYMtRCmUDJEI
NOT [VfdztiRgwtiYKC]
...
stdcall dTWcrjDsyoSYTu
IMUL AX
stdcall OpsFQBOdBx, DWORD [ClwXJwv], ESI, DWORD [FtNPNvI]
XCHG [wWCPCN], AX
stdcall wiLsHcceq, DWORD [KWSkBGWBSqf]
NOT DH
ret
endp
proc pZpbnQKbunGCi
...
NEG ECX
XCHG EAX, [uzKXEtOkP]
stdcall qPDvotYj, ECX, DWORD [FtNPNvI], EAX, DWORD [sIyIiXFei]
...
LEA AX, [fBMyjZMqdqF]
NEG AH
stdcall hrnpRA, EBX, DWORD [HTFbHCRWMmTaDX], DWORD [ClwXJwv], DWORD [QUYpLNZrBUUm], DWORD [VfdztiRgwtiYKC]
NEG BL
NEG [VfdztiRgwtiYKC]
LEA AX, [GKXHMIx]
stdcall NbILTVx
...
DEC [uzKXEtOkP]
LEA AX, [FtNPNvI]
stdcall UWWllbAYB, EDI, DWORD [GlccMbEQbjt]
SUB [qGzVfPjSXJ], wJykFe
stdcall hrnpRA, ECX, DWORD [UvzljCLLOw], DWORD [yhVQJZcxlKmOJT], EAX, DWORD [fBMyjZMqdqF]
RCL EDI, 25
stdcall kvOrvnqN
RCR AL, 5
LEA EAX, [IEgxozxZLT]
...
MOV AX, AX
LEA ESI, [GlccMbEQbjt]
stdcall NbLQgcFlI, DWORD [VfdztiRgwtiYKC], EAX, EDX, EDI, DWORD [uHwOzZSpyZ]
DEC [sIyIiXFei]
...
endp
proc bdiRiQIcDTn
stdcall CGEJUEhZLrI, DWORD [ikoFcsgiPPbfji]
MOV EAX, 20
...
MOV EAX, 20
MOV AX, AX
stdcall fUnxQYhu, DWORD [HqoYjIIw], EBX, DWORD [VfdztiRgwtiYKC]
IMUL DL
CLD
...
proc VNjpPZsjhvH
NEG AX
stdcall VjpIma, EDI, EDX, ECX, EAX
LEA AX, [wWCPCN]
SAL [MhwByhcPkSHB], 8
MOV AX, AX
MOV AX, AX
CLC
stdcall VjpIma, EDX, DWORD [PQXpOZEuMCCfD], EBX, ESI
ret
endp
...
stdcall GSikAOA
SAR [RxfBmAdCaqw], 1
stdcall fUnxQYhu, EDX, DWORD [QUYpLNZrBUUm], ECX
MOV EAX, 20
INC [sczACNd]
NEG EBX
IMUL ESI
